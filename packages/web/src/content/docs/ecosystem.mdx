...
| [opencode-antigravity-auth](https://github.com/NoeFabris/opencode-antigravity-auth)                | **DEPRECATED**: Antigravity Manager is now built-in. Select `antigravity-manager/*` models.    |
