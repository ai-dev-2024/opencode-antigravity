      ...
      loader: async (getAuth: GetAuth, provider: Provider): Promise<LoaderResult | Record<string, unknown>> => {
        ...
        return {
          ...
          async fetch(input, init) {
            ...
            // Check if this is an Antigravity model request - bypass non-Antigravity models
            // This allows OpenCode's built-in free models (Grok, MiniMax, etc.) to work correctly
            if (!isAntigravityModelRequest(input)) {
